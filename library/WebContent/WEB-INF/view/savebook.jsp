   ...
   <div class="navbar">
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
        <form id="tab" action="${bookbean==null?'save_book_info.bookdo':'update.bookdo'}" method="post" name="form1" onsubmit="return check()">	
			<div class="btn-toolbar">
    <button class="btn btn-primary" type="submit"><i class="icon-save"></i>${bookbean==null?" Save":"Update"}</button>
    <input type="reset"  class="btn" value="Reset" />
			...
			<table align="center"  width="350">
							...
							<tr>
								...
								<td><input type="text" name="serialnum" value="${ bookbean==null?'':bookbean.serialnum}"/></td>
							</tr>
							<tr>
								<td align="right">图书名称：</td>
								<td><input type="text" name="name" value="${ bookbean==null?'':bookbean.name}"/></td>
							</tr>
							<tr>
								<td align="right">价 格：</td>
								<td><input type="text" name="price" value="${ bookbean==null?'':bookbean.price}"/></td>
							</tr>
							<tr>
								<td align="right">数量：</td>
								<td><input type="text" name="count" value="${ bookbean==null?'':bookbean.bookCount}"/></td>
							</tr>
							<tr>
								<td align="right">作  者：</td>
								<td><input type="text" name="author" value="${ bookbean==null?'':bookbean.author}"/></td>
							</tr>
							<tr>
								<td align="right">出版社：</td>
								<td><input type="text" name="press" value="${ bookbean==null?'':bookbean.press}"/></td>
							</tr>
						</table>
             		<footer>
                        <hr>
