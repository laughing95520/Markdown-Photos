   ...
   <div class="navbar">
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
        <form id="tab" action="find_book.bookdo" method="post" name="form1" onsubmit="return check()">	
			<div class="btn-toolbar">
    <button class="btn btn-primary" type="submit"><i class="icon-save"></i>find</button><span>查询条件:</span>
			</div>
			<div id="findif">
    ...
    <script type="text/javascript">
        ...
        function check() {
			...
			if(form1.iftext.value==""&&document.getElementById("pid").selectedIndex!=0){
				alert("name不能为空！");
				return false;
			}
			return true;
